...
namespace qyk {
	...
	struct iterator_traits<iterator<Category,T>>{
		typedef typename iterator<Category, T>::iterator_category	iterator_category;
		typedef typename iterator<Category, T>::value_type			value_type;
		typedef typename iterator<Category, T>::difference_type		difference_type;
		typedef typename iterator<Category, T>::pointer				pointer;
		typedef typename iterator<Category, T>::reference			reference;
	};
	...
	struct is_iterator {
		...
		static auto test(int) -> decltype (
			void(typename iterator_traits<U>::iterator_category()), true_type{}
		);
